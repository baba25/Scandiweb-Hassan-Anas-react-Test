  ...
  render() {
    ...
    <ul className='menus'>
        <NavLink exact activeClassName="active" to="/">
            <p className='menus'>All</p>
        </NavLink>
        <NavLink className='men_link' activeClassName="active" to="/tech">
            <p className='menus'>Tech</p>
        </NavLink>
        <NavLink className='kids_link' activeClassName="active" to="/clothes">
            <p className='menus'>Clothes</p>
        </NavLink>
    </ul>
